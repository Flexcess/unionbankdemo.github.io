            ...
            'Personal_Accounts': {'Current Accounts': 'personal/RegularCurrentAccount.html',
                ...
                'International_Treasury': {'State of Art': 'personal/TreasuryStateOfTheArt.html',
                 ...
                 'MSME_Schemes' : { 'Union High Pride' : 'personal/MSMEUnionHighPride.html',
                  ...
                  'Rural & Agri_Long Term Credit' : {  'Irrigation' : 'personal/',
                                                       'Land Reclamation & Devt' : 'personal/',
                                                       'Land Purchase' : 'personal/',
                                                       'Farm Mechanization' : 'personal/',
                                                       'Bio gas' : 'personal/',
                                                       'Union Mortgage for Farmers' : 'personal/',
                                                       'Construction of Cold Storage' : 'personal/',
                                                       'Purchase of 2, 3, 4 wheelers' : 'personal/',
                                                       'Sericulture' : 'personal/',
                                                       'Bhumiheen Green Card' : 'personal/',
                                                       'Union White card' : 'personal/',
                                                       'Allied activities' : 'personal/',
                                                       'Agri Clinics / Busn.Centres' : 'personal/',
                                                       'Purchase of Land for Agricultural' : 'personal/',
                                                       'Estate Purchase Loan' : 'personal/',
                                                       'Kisan All Purpose Term Loan' : 'personal/',
                                                       'Kisan Tatkal Scheme' : 'personal/',
                                                       'Energy Scheme' : 'personal/',   
                                                       'UNION BIO TECH' : 'personal/'},                                                                                                                                                                                             
        },
        count = 0,
        catStr = '';
